...
PY_VER_M="${PY_VER}m"
OCV_PYTHON="-DBUILD_opencv_python2=0 -DBUILD_opencv_python='' -DBUILD_opencv_python3=1 -DPYTHON3_EXECUTABLE=$PYTHON -DPYTHON3_INCLUDE_DIR=$PREFIX/include/python${PY_VER_M} -DPYTHON3_LIBRARY=${PREFIX}/lib/libpython${PY_VER_M}m.${DYNAMIC_EXT}"
